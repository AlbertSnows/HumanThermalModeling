...
if __name__ == "__main__":
    phase5 = threading.Thread(target=triangle_smoothening)
    phase6 = threading.Thread(target=add_centroid)
    phase7 = threading.Thread(target=calc_surface_area)
    phase8 = threading.Thread(target=calc_volume)
