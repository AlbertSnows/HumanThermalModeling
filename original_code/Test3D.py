    ...
    for j in range(ellip.ny):
        for i in range(ellip.nx):
            ...
            if(dom[i,j,g] == 0):
                ...
                i_cor_vox.append(p) ; j_cor_vox.append(p) ; UA_vox_data.append(1.0)
#                UA_v[p,p] = 1.0
                Q[p,0] = Ta
                ...
                i_cor_vox.append(p) ; j_cor_vox.append(pr) ; UA_vox_data.append(uar)
                i_cor_vox.append(p) ; j_cor_vox.append(pl) ; UA_vox_data.append(ual)
                i_cor_vox.append(p) ; j_cor_vox.append(pt) ; UA_vox_data.append(uat)
                i_cor_vox.append(p) ; j_cor_vox.append(pb) ; UA_vox_data.append(uab)
                i_cor_vox.append(p) ; j_cor_vox.append(pf) ; UA_vox_data.append(uaf)
                i_cor_vox.append(p) ; j_cor_vox.append(pbk) ; UA_vox_data.append(uabk)
                i_cor_vox.append(p) ; j_cor_vox.append(p) ; UA_vox_data.append(-(uar + ual + uat + uab + uaf + uabk))
